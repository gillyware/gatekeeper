...
import { deactivateEntity } from '@/lib/entities';
import { type EntityDeactivationText, manageEntityText } from '@/lib/lang/en/entity/manage';
...
interface DeactivateEntityProps<E extends GatekeeperEntity> {
    entity: GatekeeperEntity;
    entityModel: GatekeeperEntityModelMap[E];
    updateEntity: (newEntity: GatekeeperEntityModelMap[E]) => void;
}

export default function DeactivateEntity<E extends GatekeeperEntity>({ entity, entityModel, updateEntity }: DeactivateEntityProps<E>) {
    const api = useApi();
    const [entityName, setEntityName] = useState<string>('');
    const [processing, setProcessing] = useState<boolean>(false);
    const [error, setError] = useState<string | null>(null);
    const language: EntityDeactivationText = useMemo(() => manageEntityText[entity].entityDeactivationText, [entity]);

    const submitDeactivation = async (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        ...
        deactivateEntity(api, entity, entityModel.id, updateEntity, setProcessing, setError);
    };
            ...
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <form className="space-y-6" onSubmit={submitDeactivation}>
