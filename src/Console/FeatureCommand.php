...
class FeatureCommand extends AbstractBaseEntityCommand
{
    ...
    protected function getActionOptions(): array
    {
        return [
            ...
            AuditLogAction::AssignFeature->value => 'Turn off one or more features to a model',
            AuditLogAction::RevokeFeature->value => 'Turn on one or more features from a model',
        ];
    }
