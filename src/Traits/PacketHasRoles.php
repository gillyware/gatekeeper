...
trait PacketHasRoles
{
    ...
    {
        return Gatekeeper::for($this->getModel())->assignRole($role);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->assignAllRoles($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->unassignRole($role);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->unassignAllRoles($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->denyRole($role);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->denyAllRoles($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->undenyRole($role);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->undenyAllRoles($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasRole($role);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasAnyRole($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasAllRoles($roles);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getDirectRoles();
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getEffectiveRoles();
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getVerboseRoles();
    }
