...
trait PacketHasPermissions
{
    ...
    {
        return Gatekeeper::for($this->getModel())->assignPermission($permission);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->assignAllPermissions($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->unassignPermission($permission);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->unassignAllPermissions($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->denyPermission($permission);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->denyAllPermissions($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->undenyPermission($permission);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->undenyAllPermissions($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasPermission($permission);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasAnyPermission($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->hasAllPermissions($permissions);
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getDirectPermissions();
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getEffectivePermissions();
    }
    ...
    {
        return Gatekeeper::for($this->getModel())->getVerbosePermissions();
    }
