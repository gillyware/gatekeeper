 ...
 * @method static Permission updatePermission(Permission $permission, string $permissionName)
 * @method static Permission deactivatePermission(Permission $permission)
 * @method static Permission reactivatePermission(Permission $permission)
 ...
 * @method static Role updateRole(Role $role, string $roleName)
 * @method static Role deactivateRole(Role $role)
 * @method static Role reactivateRole(Role $role)
 ...
 * @method static Team updateTeam(Team $team, string $teamName)
 * @method static Team deactivateTeam(Team $team)
 * @method static Team reactivateTeam(Team $team)
