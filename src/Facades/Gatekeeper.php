 ...
 * @method static bool assignFeatureToModel(Model $model, Feature|FeaturePacket|string|UnitEnum $feature)
 * @method static bool assignAllFeaturesToModel(Model $model, array|Arrayable $features)
 * @method static bool revokeFeatureFromModel(Model $model, Feature|FeaturePacket|string|UnitEnum $feature)
 * @method static bool revokeAllFeaturesFromModel(Model $model, array|Arrayable $features)
